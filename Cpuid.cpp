...
// Global Variable /////////////////////////////////////////////
int clone_flag;             // Flag to show whether processor is an Intel clone
...
{
  struct TIME_STAMP timestamp;    // Return variable for time stamp read
